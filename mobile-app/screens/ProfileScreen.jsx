import { View, Text, TouchableOpacity, Image, Modal, TextInput, ScrollView, FlatList } from "react-native";
      ...
      <View style={styles.container}>
        ...
        <View style={styles.menuContainer}>
          {[ 
            ...
            { title: "Awards", action: () => setAwardsModalVisible(true) },
        ...
        <Modal visible={awardsModalVisible} transparent animationType="slide">
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <FlatList
                ...
                renderItem={({ item }) => (
                  <View style={styles.awardContainer}>
                    <Text style={styles.awardText}>{item.award_name}</Text>
                    <Text style={styles.awardText}>{new Date(item.award_date).toLocaleDateString()}</Text>
                  </View>
                )}
              />
              <TouchableOpacity style={styles.closeButton} onPress={() => setAwardsModalVisible(false)}>
                <Text style={styles.closeButtonText}>Close</Text>
              </TouchableOpacity>
            </View>
          </View>
